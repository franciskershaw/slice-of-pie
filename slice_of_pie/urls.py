"""slice_of_pie URL Configuration
...
urlpatterns = [
    ...
    path('remove_from_wishlist/<item_id>/', views.remove_from_wishlist, name="remove_from_wishlist"),
    path('into_basket/<item_id>/', views.into_basket, name="into_basket"),
